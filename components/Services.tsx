...
import { FaAddressBook, FaBrush } from 'react-icons/fa';
import { AiFillBuild, AiFillFormatPainter } from 'react-icons/ai';
...
const Services = () => {
    ...
    return <div className='bg-white space-y-12 lg:space-y-5 py-36'>
        <div id='serviceHeader' className={`flex flex-col items-center ${isServicesHeaderInViewPort && 'animate-slideUp duration-1000'}`}>
            ...
            <hr className='border-slate-300 max-w-xl w-full my-4' />
        </div>
        <div id='service1' className={`grid gap-10 lg:grid-cols-2 grid-cols-1 ${isServiceOneInViewPort && 'animate-slideUp duration-1000'}
         items-center space-y-7 lg:space-x-16 max-w-2xl lg:max-w-7xl mx-auto`}>
            <div className='flex flex-col lg:space-y-0 space-y-8 lg:flex-row items-center lg:items-start justify-start space-x-5'>
