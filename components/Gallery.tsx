...
const Gallery = () => {
    return <div className='bg-white h-full flex items-center w-full'>
        <div className='mt-[-100px] max-w-6xl pb-32 mx-auto'>

            <div className='grid grid-cols-2'>
                <div className='relative transition duration-300 overflow-hidden cursor-pointer group'>

                    <img className='group-hover:scale-110 h-[600px] object-cover transition duration-700 ' src="https://preview.colorlib.com/theme/glint/images/portfolio/gallery/g-shutterbug.jpg.webp" alt="" />
                ...
                <div className='relative transition duration-300 overflow-hidden cursor-pointer group'>
                    <img className='group-hover:scale-110 h-[600px] object-cover transition duration-700 ' src="https://preview.colorlib.com/theme/glint/images/portfolio/gallery/g-woodcraft.jpg.webp" alt="" />
                    <div className='hidden bg-black-dark bg-opacity-75 duration-700
                    transition-all flex-col justify-between p-8
                     absolute text-white top-0 right-0 w-full
                      group-hover:flex
